...
1. Бонус за отзыв на сайте выдается только после написания отзыва. **Отзыв** можно написать [здесь](https://taplink.ru/profile/16700298/pages/). **Отзыв должен быть конструктивным и написан о своем личном опыте прохождения любого курса на сайте code-basics. В случае, если условие не выполнено, то мы вправе отказать в выдаче бонуса.** 
...
Активировать промокод можно в специальном разделе.
